...
export default function Testimonials() {
  return (
    <section className="mx-auto max-w-5xl px-6 py-10 sm:px-8 sm:py-16">
      <Reveal>
        <h2 className="font-serif text-4xl italic text-foreground sm:text-5xl">Testimonials</h2>
      ...
      <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {testimonials.map((t, i) => (
          <Reveal key={t.name} delay={(i % 3) * 0.1}>
            <div className="flex h-full flex-col gap-4 rounded-2xl border border-border bg-white/[0.03] p-6">
